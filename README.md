...
Each project includes **demo GIFs or videos** for easy visualization of the functionality.
...
This project demonstrates receiving data from an SPI master (e.g., STM32F407).

#### Connections

![SPI Slave Connections](media/spi_slave_connections/spi_slave_connections.gif)
