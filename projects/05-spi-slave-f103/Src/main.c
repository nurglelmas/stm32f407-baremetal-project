...
int main(void)
{
    ...
    while(1)
    {
        ...
        // 3) Toggle the LED each time new data arrives from the master
        LED_Toggle();

        // rxBuffer now holds the received string
        // Set a breakpoint here to inspect it via terminal or debugger
    }
}
