...
/*
 * ARM Cortex Mx Processor Priority register Adresses Calculation
 */
...
typedef struct
{
	...
	__vo uint32_t DR;				/*< SPI data register								Address offset:0x1C  */
...
typedef struct
{
	...
	uint32_t RESERVED[2];			/*< TODO													Reserved, 0x18-0x1C */
 ...
 *  TODO:Ypu may complete this list for other peripherals
 */
